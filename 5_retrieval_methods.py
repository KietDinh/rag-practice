...
from constants import EMBEDDING_MODEL_NAME, CHROMA_COLLECTION_METADATA
...
# # Ex: I found 20 articles about Python, instead of giving 3 most similar ones
# # it might give 1 about syntax, 1 about applications, 1 about snakes
# # ──────────────────────────────────────────────────────────────────
...
retriever = db.as_retriever(
    search_type="mmr",
    search_kwargs={
        "fetch_k": 10,  # Initial pool to select from which is 10 most similar docs
        "lambda_mult": 0.5,  # 0=max diversity, 1=max relevance
        "k": 3,  # Final number of docs selecting from the fetch_k pool applying lambda_mult
    },
)
